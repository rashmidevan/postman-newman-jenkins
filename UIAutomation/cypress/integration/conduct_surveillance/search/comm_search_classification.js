...
describe("Validate communication search page for emotion - anger/joy/negative/positive/sad", () => {
    ...
    it('search email on classification - confidential ', () =>{
        ...
        cy.wait(1000)
        cy.get('.form :nth-child(10) > .bx--multi-select > .bx--list-box__field > .bx--list-box__menu-icon > svg').click()
        cy.wait(2000)
        cy.get('.form .bx--multi-select .bx--list-box__menu .bx--form-item').children()
                .contains('Confidential').click()
        cy.get('.form .buttons > .bx--btn').click()
        cy.wait(2000)
        cy.get('.bx--pagination__left > :nth-child(3)').contains('1-1 of 1 items')
        cy.get('.communication-card-description > p').contains('Joe Jamail VERY CONFIDENTIAL The following member has asked for help from the Inventory of Skills (IOS). You have been identified as one of the few members who has the skill to assist in this area. You may or may...')
    })
    it('search email on classification - non-confidential ', () =>{
        cy.get('.form #alert-id').type('1')
        cy.wait(1000)
        cy.get('.form :nth-child(1) > .bx--multi-select > .bx--list-box__field > .bx--list-box__menu-icon >svg').click()
        cy.wait(2000)
        ...
        cy.wait(2000)
        cy.get('.form .bx--multi-select .bx--list-box__menu .bx--form-item').children()
                .contains('Non-Confidential').click()
        cy.get('.form .buttons > .bx--btn').click()
        cy.wait(2000)
        cy.get('.bx--pagination__left > :nth-child(3)').contains('1-6 of 6 items')
        cy.get(':nth-child(1) > .card-content > .sub-content > .communication-card-description > p').contains('Hi Today was another bad day. I am frustrated here at work where things are hectic and creating all sorts of chaos. All the good work goes un-noticed. I hate when people put up un-necessary pressure due their mis-doings. I...')
    })
});